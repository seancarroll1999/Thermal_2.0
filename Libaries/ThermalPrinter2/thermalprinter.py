...
class ThermalPrinter(Serial):
    ...
    def set_options(self, heat_time, heat_interval, heat_point):
        self.send_command(Command.ESC, 55, most_heated_point,
                          heat_time, heat_interval)
    ...
    def charset(self, charset=CharSet.UK):
    ...
    def codepage(self, codepage=CodePage.CP850):
